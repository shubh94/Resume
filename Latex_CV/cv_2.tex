...
\begin{document}
\moveleft.5\hoffset\centerline{\large\bf Shubham Agrawal} % Your name at the top
...
\moveright1.4\hoffset\centerline{{\bf Email}: shubhag@iitk.ac.in} % Your address
\moveright1.2\hoffset\centerline{{\bf Homepage}: home.iitk.ac.in/~shubhag} % Your address
\begin{resume}
\section{EDUCATION}
{\sl B.Tech,} Computer Science and Technology \\
Indian Institute of Technology,Kanpur, expected May 2016 \\
\begin{itemize}
\item CGPA(after 4 semesters): {\bf 8.6}
\item Precentage (10+2): {\bf 89\%}
\item GPA(High School): {\bf 9.8}
\end{itemize}
\section{SHOLASTIC ACHIEVEMENTS}
\begin{itemize}
\item Secured All India Rank {\bf 155} in {\bf IIT-JEE} among 500,000 candidates.
\item Secured All India Rank {\bf 105} in {\bf AIEEE} among 1,000,000 candidates.
\item Selected for the Indian National Astronomy Olympiad({\bf INAO}) amomg {\bf top 30} students in India.
\item Ranked {\bf 4} in Regional Mathematics Olympiad({\bf RMO}).
...
{\sl {\bf Coding Languages}:} C, C++, Python, Perl, Bash, HTML, Javascript, CSS, XML, MySQL \\
{\sl {\bf Other tools}:} GNU Octave, Latex, Git.\\
